...
df = pd.read_csv('/Users/ethanmoscot/Desktop/GAO AI/gao-ai/gao_data.csv') #Personal file path
#df.head()
#df = df.values

X = df.iloc[:,1:26] #input features (GAO data criteria)
...
#(700, 25) (150, 25) (150, 25) (700,) (150,) (150,)
...
model = Sequential([ #hidden layer followed by output layer
    Dense(units=6, activation='relu', input_shape=(25,)),
    Dense(units=1, activation='sigmoid')
])

#Fit model
model.compile(optimizer='sgd', loss='binary_crossentropy', metrics='accuracy')
#num_epochs = 3 * 25 (input nodes)
hist = model.fit(X_train, Y_train, batch_size=32, epochs=75, validation_split=0.1, validation_data=(X_val, Y_val))
