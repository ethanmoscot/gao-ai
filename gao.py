...
df = pd.read_csv('gao_dataset_063023.csv') #Personal file path
...
#(700, 93) (150, 92) (150, 93) (700,) (150,) (150,)
#training: 700 datapoints, validation and test: 150 points
#X has 93 input features, Y only has 1 (i.e., the results)
...
model = Sequential([ #two hidden layers followed by output layer
    Dense(units=4, activation='relu', input_shape=(93,)),
...
#Fit model
hist = model.fit(X_train, Y_train, batch_size=16, epochs=40, validation_data=(X_val, Y_val))
#Evaluate on training and test data
train_mse = model.evaluate(X_train, Y_train)[1]
test_mse = model.evaluate(X_test, Y_test)[1]
