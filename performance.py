...
df = pd.read_csv('/Users/ethanmoscot/Desktop/GAO AI/gao-ai/gao_performance.csv') #Personal file path
#df.head()
#df = df.values

X = df.iloc[:,1:29] #input features (GAO performance criteria)
...
#(700, 28) (150, 28) (150, 28) (700,) (150,) (150,)
...
model = Sequential([ #hidden layer followed by output layer
    Dense(units=6, activation='relu', input_shape=(28,)),
    Dense(units=1, activation='sigmoid')
])

#Fit model
model.compile(optimizer='sgd', loss='binary_crossentropy', metrics='accuracy')
#num_epochs = 3 * 28 (input nodes)
hist = model.fit(X_train, Y_train, batch_size=32, epochs=84, validation_split=0.1, validation_data=(X_val, Y_val))
